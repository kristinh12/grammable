...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#edit action" do
    ...
    it "shouldn't let a user who not not create the gram to edit the gram" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
      get :edit, params: { id: gram.id }
  ...
  describe "grams#update action" do
    ...
    it "shouldn't let a user that did not create a gram to update it" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
      patch :update, params: { id: gram.id, gram: { message: "Hello" } }
  ...
  describe "grams#destroy action" do
    ...
    it "shouldn't let a user that not not create a gram to destroy it" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
      delete :destroy, params: { id: gram.id }
